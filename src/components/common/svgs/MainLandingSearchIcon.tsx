...
const SvgMainLandingSearchIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      ...
      fill="#ADB5BD"
    />
    <circle cx={11.5} cy={11.5} r={6.32094} stroke="#ADB5BD" strokeWidth={2.35812} />
  </svg>
)

export default SvgMainLandingSearchIcon
