...
const SvgFilterIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M13.875 16.125H3.75" stroke="#21252B" strokeWidth={1.6} strokeLinecap="square" strokeLinejoin="round" />
    <path d="M20.25 16.125H17.625" stroke="#21252B" strokeWidth={1.6} strokeLinecap="square" strokeLinejoin="round" />
    <path
    ...
    />
    <path d="M7.875 7.875H3.75" stroke="#21252B" strokeWidth={1.6} strokeLinecap="square" strokeLinejoin="round" />
    <path d="M20.25 7.875H11.625" stroke="#21252B" strokeWidth={1.6} strokeLinecap="square" strokeLinejoin="round" />
    <path
